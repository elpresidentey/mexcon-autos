...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-metallic-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        {/* Logo and Title */}
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-primary-600 rounded-xl flex items-center justify-center shadow-card">
          ...
          <p className="mt-2 text-metallic-600">
        ...
        {/* Footer Note */}
        <p className="mt-8 text-center text-sm text-metallic-500">
